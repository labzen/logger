...
abstract class AbstractTile<out R> : Tile<R> {

  internal var next: Tile<*>? = null

  override fun hasNext() = next != null

  override fun setNext(tile: Tile<*>) {
    this.next = tile as AbstractTile<*>
  }

  override fun getNext(): Tile<*>? = next
  ...
  companion object {
    ...
    fun match(tileText: String): AbstractTile<*>? =
      when {
